        ...
        <div class="container">
            ...
            <div class="installment-v2">
                ...
                <div class="data">
                    <div class="header">
                        <ul>
                            <li><a href="#" class="actived">Trả góp qua công ty tài chính</a></li>
                        </ul>
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <select class="select-opt" onchange="location.href = this.value;">
                                                {{-- <option value="{{\App\Library\Helpers::getSearch(\Request::fullUrl(),'prepaid_percentage','0')}}" {{isset($url_params['prepaid_percentage']) && $url_params['prepaid_percentage'] == 0 ? 'selected' : null }}>0%</option> --}}
