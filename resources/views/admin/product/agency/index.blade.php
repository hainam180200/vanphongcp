...
@section('content')
    ...
    <div class="modal fade" id="listItemModal">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                @include('admin.product.agency.additem')
            </div>
        </div>
    </div>
    <!-- delete item Modal -->
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                {{Form::open(array('route'=>array('admin.'.$module.'.delete'),'class'=>'form-horizontal','id'=>'form-delete-group','method'=>'POST'))}}
                ...
                <div class="modal-footer">
                    <input type="hidden" name="group_delete_id" class="group_delete_id" value=""/>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{__('Hủy')}}</button>
                    <button type="submit" class="btn btn-danger m-btn m-btn--custom btn-submit-custom" data-form="form-delete-group">{{__('Xóa')}}</button>
                </div>
                {{ Form::close() }}
            </div>
        </div>
...
<script>
                ...
                buttons: [
                    {
                        ...
                        action : function(e) {
                            ...
                            $('#deleteModal .group_delete_id').attr('value', allSelected);
    ...
    jQuery(document).ready(function () {
        ...
        $('#deleteModal').on('show.bs.modal', function(e) {
            ...
            $('#deleteModal .group_delete_id').attr('value', id);
        });
...
<script>
    jQuery(document).ready(function () {
        ...
        $('#txtSearch').donetyping(function() {
            var find=$(this).val()
            var id = $('#id-group-search').val();
            var module = $('input#module_group').val();
            var url ='{{route('admin.product-agency.search')}}';
        ...
        $(document).on('click','.btn-show-item',function(e){
            e.preventDefault();
            var module = $('input#module_group').val();
            var url = '{{route('admin.product-agency.show-item')}}';
            $('#result-search .rs-item').remove();
            $('#txtSearch').val('');
            var id = $(this).data('id');
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.status == 1){
                        ...
                        $('body').append('<input type="text" value="'+data.id+'" id="id-group-search" style="display: none">')
                        let html = '';
                        let parent_id = 0;
                        ...
                        console.log(html);
                        $('#listItemModal #nestable .dd-list').html(html);
        ...
        $(document).on("click",".btnAppend",function(e) {
            e.preventDefault();
            var module = $('input#module_group').val();
            var url = '{{route('admin.product-agency.update-item')}}';
        ...
        $(document).on('click','.btn-delete-item',function(e){
            e.preventDefault();
            var module = $('input#module_group').val();
            var url = '{{route('admin.product-agency.delete-item')}}';
            var id = $(this).data('id');
