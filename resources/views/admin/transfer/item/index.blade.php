            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'id', title: 'ID'},
                        {
                            data: 'author_id', title: '{{__('Người dùng')}}',
                            render: function (data, type, row) {
                                 return row.author_id;
                            }
                        },
                        {
                            data: 'bank_name', title: '{{__('Ngân hàng')}}',
                            render: function (data, type, row) {
                                 return row.bank_name;
                            }
                        },
                        {
                            data: 'number_account', title: '{{__('Số tài khoản')}}',
                            render: function (data, type, row) {
                                 return row.number_account;
                            }
                        },
                        {
                            data: 'id', title: '{{__('Nội dung')}}',
                            render: function (data, type, row) {
                                var text = "NAP PZ "+row.id
                                 return text;
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                if (row.status == 1) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-success \"> Số tiền đúng </span>";
                                }
                                if (row.status == 3) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  label-info \"> Số tiền sai </span>";
                                }
                                else if (row.status == 2) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2 label-warning \"> Đang chờ </span>";
                                } 
                                else if(row.status == 0){
                                    return "<span class=\"label label-pill label-inline label-center mr-2 label-danger \"> Thất bại </span>";
                                }
                            }
                        },
