...
class ReportController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->module="installment-report";
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.installment.report.index')
