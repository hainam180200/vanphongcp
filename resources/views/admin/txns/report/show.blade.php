...
<div class="modal-body">
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td>Tài khoản:</td>
            <td>
                <a href="#" class="load-modal" rel="/admin/view-profile?username={{$datatable->user->email??""}}">{{$datatable->user->email??""}}</a>
        ...
        @if($datatable->processor_username!="")
            <tr>
                ...
                <td>
                    <a href="#" class="load-modal" rel="/admin/view-profile?username={{$datatable->processor_username}}">{{$datatable->processor_username}}</a>
                </td>
            </tr>
        @endif
        </tbody>
    ...
    @elseif($datatable->trade_type=="charge")
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="load-modal" rel="/admin/view-profile?username={{$datatable->txnsable->email??""}}">{{$datatable->txnsable->email??""}}</a>
                        </td>
                    </tr>
                    <tr>
                        <td>Cổng gạch thẻ:</td>
