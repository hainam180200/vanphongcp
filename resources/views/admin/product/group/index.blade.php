    ...
    <div class="modal fade" id="listItemModal">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                @include('admin.product.group.additem')
            </div>
        </div>
    </div>
    <!-- delete item Modal -->
...
<script>
    jQuery(document).ready(function () {
        ...
        $('#txtSearch').donetyping(function() {
            ...
            var url ='{{route('admin.product-group.search')}}';
        ...
        $(document).on('click','.btn-show-item',function(e){
            e.preventDefault();
            var module = $('input#module_group').val();
            var url = '{{route('admin.product-group.show-item')}}';
            $('#result-search .rs-item').remove();
            $('#txtSearch').val('');
            var id = $(this).data('id');
        ...
        $(document).on("click",".btnAppend",function(e) {
            e.preventDefault();
            var module = $('input#module_group').val();
            var url = '{{route('admin.product-group.update-item')}}';
        ...
        $(document).on('click','.btn-delete-item',function(e){
            e.preventDefault();
            var module = $('input#module_group').val();
            var url = '{{route('admin.product-group.delete-item')}}';
            var id = $(this).data('id');
