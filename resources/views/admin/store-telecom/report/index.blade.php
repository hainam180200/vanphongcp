                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control datatable-input" id="tranid" value="{{request('tranid')}}" placeholder="{{__('Mã nhà cung cấp')}}">
                        </div>
                    </div>
                    {{--username--}}
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                    ...
                    columns: [
                        ...
                        {data: 'real_received_price', title: '{{__('Tổng thanh toán')}}'},
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                if (row.gate_id == 1) {
                                    return "<span class=\"label label-pill label-inline label-center mr-2  \" data-toggle=\"tooltip\"itle data-original-title=\"" + row.description +"\">" + "{{config('module.store-card.gate_id.1')}}" + "</span> <br/> "+row.tranid;
                                }
                                else {
