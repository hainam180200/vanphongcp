            ...
            var initTable1 = function () {
                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'processor.email', title: '{{__('Người thao tác')}}', orderable: false, searchable: false,
                            render: function (data, type, row) {
                                var temp=row.processor.email??"";
                                return temp;
                            }
                        },
                        {data: 'user.email', title: '{{__('Người nhận')}}', orderable: false, searchable: false,
                            render: function (data, type, row) {
                                var temp=row.user.email??"";
                                return temp;
                            }
                        },
                        {
