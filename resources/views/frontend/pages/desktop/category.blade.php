    ...
    <div class="container">
        <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
            ...
            @if (isset($breadcumb) && count($breadcumb) > 0)
                ...
                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <a itemprop="item" href="{{isset($item->url) ? $item->url : $item->slug}}"><span itemprop="name" content="{{$item->title}}">{{$item->title}}</span></a>
            ...
            <li><i class="fas fa-chevron-right"></i></li>
            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                <a itemprop="item" href="{{isset($data->url) ? $data->url : $data->slug}}" title="{{$data->title}}" class="actived"><span itemprop="name" content="{{$data->title}}">{{$data->title}}</span></a>
                <meta itemprop="position" content="{{isset($breadcumb) && count($breadcumb) > 0 ? count($breadcumb) + 2 : '3' }}" />
            </li>
        </ol>
    </div>
</section>
...
<section>
    <div class="container">
        ...
        <div class="more-product" id="page-pager">
            {{-- <a href="javascript:getPage(2)">Xem thêm 13 sản phẩm</a> --}}
