   ...
   <div class="card-header">
      <div class="card-title">
         <h3 class="card-label">
            ...
            <span class="label label-lg label-pill label-inline label-dark mr-2">{{config('order.status.1')}}</span>
            ...
            <span class="label label-lg label-pill label-inline label-success mr-2">{{config('order.status.4')}}</span>
            @else
            ""
            @endif
         </h3>
      ...
      <table class="table">
         <thead class="thead-default">
            ...
            <tr>
               ...
               <th class="th-value">
                  {{App\Library\HelperOrder::getProvinces($detail)}}
               </th>
            </tr>
            <tr>
               <th class="th-index">
               ...
               <th class="th-value">
                  {{App\Library\HelperOrder::getDistricts($detail)}}
               </th>
            </tr>
            <tr>
               <th class="th-index">
               ...
               <th class="th-value">
                  {{App\Library\HelperOrder::getValDetai($detail,'address')}}
               </th>
            </tr>
         </thead>
         <tbody>
    ...
    {{Form::open(array('route'=>array('admin.order.update-item',$data->id),'method'=>'POST','enctype'=>"multipart/form-data"))}}
        <div class="form-group row">
            <div class="col-12 col-md-6">
                ...
                {{Form::select('status',config('order.status'),old('status', isset($data) ? $data->status : null),array('class'=>'form-control select-option'))}}
                <br>
...
<div class="modal fade" id="updateModal" tabindex="-1" role="basic" aria-hidden="true">
    <div style="text-align:initial;" class="modal-dialog">
        <div class="modal-content">
            {{Form::open(array('route'=>array('admin.order.update-item',$data->id),'class'=>'m-form','method'=>'POST'))}}
