                ...
                datatable = $('#kt_datatable').DataTable({
                    ...
                    columns: [
...

                        {
                            ...
                            render: function (data, type, row) {
                                if( row.email+"" !="null"){
                                    var temp = "<a href=\"#\" class=\"load-modal\" rel=\"{{route('admin.view-profile',['username'=>""])}}" + row.email + "\">" + row.email + "</a>";
                                    return temp;
                                }
                                else{
                                    return "";
                            ...
                            {{--            return "<span class=\"label label-pill label-inline label-center mr-2 label-primary \">" + "{{config('module.user.account_type.1')}}" + "</span>";--}}
                            {{--        }--}}
                            {{--        else if(row.account_type==2) {--}}
                            {{--            return "<span class=\"label label-pill label-inline label-center  mr-2 label-success \">" + "{{config('module.user.account_type.2')}}" + "</span>";--}}
                            {{--        }--}}
                            {{--        else{--}}
                            {{--            return "<span class=\"label label-pill label-inline label-center mr-2 label-success \">" + "{{config('module.user.account_type.3')}}" + "</span>";--}}
                            {{--        }--}}
                            {{--    }--}}
                            {{--},--}}
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                temp += "<span class='text-danger'>" + "- " + number_format(data.balance_out,".") + "</span><br/>";
                                temp += "<span class=''>" + "Dư: " + number_format(data.balance_in - data.balance_out- data.balance,".") + "</span><br/>";

                                var not_equal = data.balance_in - data.balance_out - row.balance
                                if (not_equal != 0) {
