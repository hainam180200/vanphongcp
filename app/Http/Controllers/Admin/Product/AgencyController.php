...
class AgencyController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->moduleCategory=$this->module.'-agency';
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.product.agency.index')
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.product.agency.create_edit')
            ->with('module', $this->module)
            ->with('page_breadcrumbs', $this->page_breadcrumbs)
            ->with('dataCategory', $dataCategory);
    }
    ...
    public function search(Request $request){
         $module = str_replace('-agency','',$this->module);
         $group_id = $request->id;
         ...
         return view('admin.product.agency.search')
    ...
    public function updateItemGroup(Request $request){
         ...
         if($item->status == 0){
             return response()->json([
                 'status' => 0,
                 'message' => "Văn bản không hoạt động",
             ]);
         }
         ...
         // check xem field đã có item này hay chưa
    ...
    public function deleteItemGroup(Request $request){
         ...
         if(!$group_item){
             return response()->json([
                 'status' => 0,
                 'message' => 'Dữ liệu không tồn tại trong nhóm',
             ]);
         }
