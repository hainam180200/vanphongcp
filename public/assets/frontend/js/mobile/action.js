...
//         var u = $(".btnQuickOrder").hasClass("disabled") || $(".btnQuickOrder").hasClass("btn-outstock"),
//             i, n, t, r;
//         u || (i = $(this).attr("data-sku"), n = $("#colorOptions .selected").attr("data-id"), n = n ? n : -1, t = cartGetCookie(), t ? (r = t.findIndex(n => n.sku == i), n && (r = t.findIndex(t => t.sku == i && t.color == n)), r >= 0 ? t[r].number++ : (t.push({
//             sku: i,
//             number: 1,
//             color: n
...
//         }), $.cookie("_cart", JSON.stringify(t), {
//             path: "/"
//         }), checkTotalCart(), location.href = "/cart")
//     })
// }
...
function jssor_free_drag(n, t) {
    function i() {
        ...
        n ? (console.log(n + "," + t), sliderContent.$ScaleSize(n, t)) : window.setTimeout(i, 30)
    }
    var r = {
        $SlideWidth: t,
        $FillMode: 4,
...
var specsHeight, setProductContentHeighWithSpecs = function() {
...
sliderTestimonial_init = function() {
    var i = $("#jssor_testimonial").length,
        t, n;
    if (i) {
        t = {
            $AutoPlay: !0,
        ...
        function i() {
            ...
            t ? (t = Math.min(t, 640), n.$ScaleWidth(t)) : window.setTimeout(i, 30)
        }
        i();
