                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-sm-6 col-lg-3">
                        <div class="input-group">
                            ...
                            {{Form::select('group_id',[''=>'-- Tất cả loại thẻ --']+$telecom,old('group_id',request('group_id')),array('id'=>'group_id','class'=>'form-control datatable-input',))}}
                        </div>
                    </div>
                    ...
                    columns: [
                        ...
                        {data: 'id', title: 'ID'},
                        {
                            data: 'created_at', title: '{{__('Thời gian')}}',render: function (data, type, row) {
                                ...
                                temp+="OK:</br>"+row.created_at;
                                return temp;

                            }
                        },
                        {data: 'user_auth', title: '{{__('Tài khoản')}}'},
                        {data: 'gate_id', title: '{{__('Cổng nạp')}}', render: function (data, type, row) {

                                var arrConfig= {!! json_encode(config('module.charge.gate_id')) !!};
                        ...
                        {{--{data: 'telecom_key', title: '{{__('Nhà mạng')}}'},--}}
                        {
                        ...
                        {data: 'declare_amount', title: '{{__('Mệnh giá')}}'},
                        {
...

                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                var temp="<span class=\"c-font-bold text-primary\">+"+number_format(row.real_received_amount,'.')+"<br>("+row.ratio+")</span>";
